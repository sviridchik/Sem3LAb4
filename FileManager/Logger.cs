    ...
    public class Logger
    {
     ...
     GetValueByNameField(resFinder, "LogPath").ToString().Replace("\"", "").Replace(" ", "");
        ...
        private void RecordEntry(string fileEvent, string filePath)
        {
            ...
            ConfugurationManager.OptionsManager.DataAccess?.GetAdd("CreateLogData", new SqlParameter("@datetime", DateTime.Now.ToString("dd/MM/yyyy hh:mm:ss")), new SqlParameter("@message", String.Format("file {0} was {1}", filePath, fileEvent)));
        }
        ...
        public void RecordEntryForAction(string fileEvent)
        {
            ...
            ConfugurationManager.OptionsManager.DataAccess?.GetAdd("CreateLogData", new SqlParameter("@datetime", DateTime.Now.ToString("dd/MM/yyyy hh:mm:ss")), new SqlParameter("@message", String.Format("file  was {0}", fileEvent)));
        }
